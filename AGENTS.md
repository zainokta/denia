...
This project is indexed by GitNexus as **cli-driven-setup** (4786 symbols, 10898 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
