...
This project is indexed by GitNexus as **denia** (2528 symbols, 5419 relationships, 215 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
