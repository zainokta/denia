...
This project is indexed by GitNexus as **denia** (4709 symbols, 10796 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
