...
| Documentation | All ADRs (001–015), design specs, README, project guidance, PRODUCT.md, DESIGN.md, roadmap |
| Configuration | `.gitignore`, `local tooling/` |
| Tests | `tests/` (4 files) |
...
### Configuration
`Cargo.toml`, `Cargo.lock`, `web/package.json`, `web/pnpm-lock.yaml`, `.gitignore`, `project guidance`, `README.md`, `PRODUCT.md`, `DESIGN.md`, `roadmap`
