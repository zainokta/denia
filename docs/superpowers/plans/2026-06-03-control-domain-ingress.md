...
| `docs/adr/034-control-domain-ingress.md` (new) | ADR for public control-plane exposure (extends ADR-020). |
...
**Files:**
- Create: `docs/adr/034-control-domain-ingress.md`
...
```markdown
# ADR-034: Control Domain Over Ingress
...
Add the ADR-034 row to the table/list in `docs/adr/README.md` following the existing format.

- [ ] **Step 3: Commit**

```bash
git add docs/adr/034-control-domain-ingress.md docs/adr/README.md
git commit -m "docs(adr): ADR-034 control domain over ingress"
```
